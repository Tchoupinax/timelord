        ...
        <div class="flex items-center space-x-2">
          <div class="min-w-0">
            ...
            <span
              ...
              class="text-xs truncate block cursor-help"
              :class="
                isJobCancelled(job)
          ...
          <div class="flex items-center">
            ...
            ></div>
            <div
              v-else-if="isJobCancelled(job)"
              v-tippy="{
                content: job.statusComment ?? 'Cancelled by user',
              }"
              class="w-2 h-2 bg-orange-500 rounded-full cursor-pointer dark:bg-orange-400"
              title="Cancelled"
            ></div>
            <div
